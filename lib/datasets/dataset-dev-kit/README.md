...
- 2022/02: Finished annotation
  ...
  using [3D BAT](https://github.com/walzimmer/3d-bat) labeling tool
...
The TUM Traffic V2X Cooperative Perception Dataset (`TUMTraf-V2X`) contains 10 sequences (`s01` to `s10`) and is
